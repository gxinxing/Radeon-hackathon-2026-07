...
Fixes:
  ...
  - 20s match duration (1000 steps at 50Hz)
  - Structured JSON match log with timestamps
  - Graceful shutdown
"""
import argparse, socket, struct, json, threading, time, signal, os
...
if __name__ == '__main__':
    ...
    coord = MatchCoordinator(args.port, args.n_teams, args.log_dir)
    coord.run()
